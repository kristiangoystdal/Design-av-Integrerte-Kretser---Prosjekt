...
`include "../MAC/Half_Adder.v"
`include "../MAC/Full_Adder.v"
...
`include "../MAC/twobit_multiplier.v"
`include "../MAC/eightbit_adder.v"
`include "../MAC/eightbit_register.v"
...
module Mealy_FSM(
    ...
    //Define wires (A and B are only used internally)

    wire RunIN, ResetIN, CLK, RunOUT, ResetOUT, Set, C1, C0, N1, N0, A, B;
    ...
    onebit_register Reg0(.D(N0), .S(Set), .R(ResetIN), .CLK(CLK), .Q(C0));
    onebit_register Reg1(.D(N1), .S(Set), .R(ResetIN), .CLK(CLK), .Q(C1));
