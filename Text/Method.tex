...
The FSM is implemented and its functionality is verified using the hardware desctriptive language verilog. The code for implementing the FSM in verilog is given in \autoref{verilog_FSM} in the appendix. To simplify the implementation, the register is written as a separate module, shown in the appendix \autoref{verilog_onebitregister}.
