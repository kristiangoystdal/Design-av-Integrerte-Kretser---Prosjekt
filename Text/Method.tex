...
The FSM is implemented and its functionality is verified using the hardware desctriptive language verilog. The complete code for implementing the FSM in verilog is given in \autoref{verilog_FSM} in the appendix. An excerpt of the logic part is given below
