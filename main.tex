...
% Title
\HRule \\[0.4cm]
{ \huge \bfseries Design \& Test of a \\Multiply-Accumulate unit \\ (Midterm Delivery)}\\[0.4cm] %TODO: replace "TITLE" with some project title, e.g. "Design of a Multiply Accumulate Unit"
\HRule \\[1.5cm]
